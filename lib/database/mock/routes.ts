...
const rawRoutes: RouteSummary[] = [
  ...
  {
    id: "a7c3e9f1-4b82-4d6a-9e15-3f8a2c7d0b14",
    slug: "tokyo-drift-circuit",
    name: "Tokyo Drift Circuit",
    description: "Neon-lit street circuit weaving through the tight blocks of Shibuya and Shinjuku — hairpins under glowing billboards and 90-degree kinks between towers.",
    city: "Tokyo",
    country: "Japan",
    latitude: 35.6595,
    longitude: 139.7004,
    ...
    difficulty: "hard",
    tags: ["night", "neon", "drift", "city-streets", "japan"],
    thumbnail: "/images/routes/tokyo-drift-circuit.svg",
    checkpointCount: 14,
    surfaceType: "asphalt",
    bestTimeMs: 105000,
    attemptCount: 0,
    isPublished: true,
    dataAttribution: "Stylised Tokyo Shibuya/Shinjuku circuit — original procedural geometry",
  },
  {
    id: "b8d4f2a3-5c67-4e89-a012-4f6b8c9d1e23",
    slug: "alps-mountain-pass",
    name: "Alps Mountain Pass",
    description: "Winding hairpin switchbacks climbing through the Swiss Alps with dramatic elevation changes and stunning mountain views.",
    city: "Zermatt",
    country: "Switzerland",
    latitude: 46.02,
    longitude: 7.75,
    ...
    difficulty: "hard",
    tags: ["mountain", "hairpins", "elevation", "scenic"],
    thumbnail: "/images/routes/alps-mountain-pass.svg",
    checkpointCount: 14,
    surfaceType: "asphalt",
    bestTimeMs: 145000,
    attemptCount: 0,
    isPublished: true,
    dataAttribution: "Stylised Swiss Alps mountain pass — original procedural geometry",
  },
  {
    id: "c9e5a3b4-6d78-4f90-b123-5a7c9d0e2f34",
    slug: "rio-coast-circuit",
    name: "Rio Coast Circuit",
    description: "Racing along Copacabana with views of Sugarloaf Mountain — flowing coastal corners and tight city sections through Rio de Janeiro.",
    city: "Rio de Janeiro",
    country: "Brazil",
    latitude: -22.97,
    longitude: -43.18,
    distanceMetres: 3000,
    estimatedDurationSeconds: 185,
    difficulty: "medium",
    tags: ["coastal", "scenic", "city", "brazil"],
    thumbnail: "/images/routes/rio-coast-circuit.svg",
    checkpointCount: 14,
    surfaceType: "asphalt",
    bestTimeMs: 125000,
    attemptCount: 0,
    isPublished: true,
    dataAttribution: "Stylised Rio de Janeiro coast circuit — original procedural geometry",
  },
];
